	...
	<div style="background-color: #fafafa;padding: 20px;width:80%">
		...
		<tr>
			<td colspan="7" style="padding:20px 0;">
				Silahkan melakukan pembayaran sejumlah <em><?php echo "Rp ".number_format($row['TotalBayar'], 0, '','.'); ?></em> ke Rekening BNI (161810028696), sampai batas akhir tanggal 1 - 10 di awal Bulan.
			</td>
		</tr>	
		<tr>
			<td colspan="6"></td>
